...
OpSet DotFiller::fillPolygon(const std::vector<Point>& points, const ResolvedOptions& oo) {
  auto o = oo;
  o.curveStepCount = 4;
  o.hachureAngle = 0;
  o.roughness = 1;
...
OpSet DotFiller::dotsOnLines(const std::vector<Line>& lines, const ResolvedOptions& o) {
  std::vector<Op> ops;
