...
OpSet ZigZagLineFiller::fillPolygon(const std::vector<Point>& points, const Options& oo) {
  auto o = oo;
...
std::vector<Op> ZigZagLineFiller::zigzagLines(const std::vector<Line>& lines, double zo, const Options& o) {
  std::vector<Op>  ops;
